...
$required_fields = ['first_name', 'last_name', 'email', 'password', 'contact_number'];
...
// Insert new customer
$insert_query = "INSERT INTO customers (first_name, last_name, email, password, contact_number) 
                 VALUES ('$first_name', '$last_name', '$email', '$password', '$contact_number')";
